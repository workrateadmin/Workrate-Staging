...
workspace package (`@workspace/memphis-bold`): other artifacts depend
...
`@workspace/memphis-bold/components/...`. Never use a `@/` alias inside
...
for `@workspace/memphis-bold` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/memphis-bold` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/memphis-bold/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/memphis-bold/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/memphis-bold/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/memphis-bold/docs/migrating-expo.md`
