# Migrating web UI to Memphis Bold

Read `artifacts/memphis-bold/docs/AGENTS.md` and
`artifacts/memphis-bold/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/memphis-bold/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/memphis-bold/lib/utils`
- `@/hooks/use-toast` → `@workspace/memphis-bold/hooks/use-toast`
