        ...
        <View style={s(colors).card}>
          ...
          >
            {isLoading ? (
              ...
              <Text style={s(colors).primaryButtonText}>Verify email</Text>
            )}
          </TouchableOpacity>
  ...
  return (
    ...
    >
      <View style={s(colors).header}>
        ...
        <Text style={s(colors).tagline}>Create your account</Text>
      </View>
      ...
      <View style={s(colors).form}>
        <View style={s(colors).inputGroup}>
          ...
          {errors?.fields?.emailAddress && (
            <Text style={s(colors).errorText}>{errors.fields.emailAddress.message}</Text>
          )}
        </View>
        ...
        >
          {isLoading ? (
            ...
            <Text style={s(colors).primaryButtonText}>Create account</Text>
          )}
        </TouchableOpacity>

        <View style={s(colors).footerRow}>
          <Text style={s(colors).footerText}>Already have an account? </Text>
          <Link href="/(auth)/sign-in">
            <Text style={s(colors).linkText}>Sign in</Text>
          </Link>
        </View>
      </View>
...
const s = (colors: Colors) =>
  StyleSheet.create({
    ...
    errorText: { fontSize: 12, color: colors.destructive, fontFamily: 'Inter_400Regular' },
  });
