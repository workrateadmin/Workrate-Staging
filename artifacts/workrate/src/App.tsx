...
import InvoiceTemplateEditor from "./pages/invoice-template-editor";
    ...
    >
      <QueryClientProvider client={queryClient}>
        ...
        <Switch>
          ...
          <Route path="/settings/invoice-template-editor"><ProtectedRoute component={InvoiceTemplateEditor} /></Route>
